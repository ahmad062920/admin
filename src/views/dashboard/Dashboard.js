...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <Row className="mb-5 g-2 text-center">
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                <img src="/img/svg/Lead.svg" alt="pic" className="text-primary" />
                {/* <CsLineIcons icon="leads" className="text-primary" /> */}
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate text-md lh-1-25">Leads</div>
        ...
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
              <img src='/img/svg/order-pending.svg' alt='pic' className='text-primary'/>
                {/* <CsLineIcons icon="cart" className="text-primary" /> */}
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate text-md lh-1-25">Orders Pending </div>
        ...
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              ...
              <img src='/img/svg/order-processing.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate text-md lh-1-25">Orders Processing</div>
        ...
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              ...
              <img src='/img/svg/order-complete.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate text-md lh-1-25">Order Complete</div>
        ...
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              ...
              <img src='/img/svg/total-product.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate text-center text-md lh-1-25">Total Products</div>
        ...
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              ...
              <img src='/img/svg/in-stock.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">In Stock Products</div>
              <div className="text-primary cta-4">5</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
                <img src="/img/svg/out-of-stock.svg" alt="pic" className="text-primary" />
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Out of Stock</div>
        ...
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/on-Back-order.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">On BackOrder</div>
              <div className="text-primary cta-4">7</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/categories.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Main Categories</div>
              <div className="text-primary cta-4">9</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/sub-categories.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Sub Categories</div>
              <div className="text-primary cta-4">13</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/Brands.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Brands</div>
              <div className="text-primary cta-4">5</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/clients.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Clients</div>
              <div className="text-primary cta-4">18</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/service-pending.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Service Pending</div>
              <div className="text-primary cta-4">1</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/service-schedule.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Service Schedule</div>
              <div className="text-primary cta-4">12</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/service-confirmed.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Service Confirmed</div>
              <div className="text-primary cta-4">1</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/pending-complaints.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Complaints pending</div>
              <div className="text-primary cta-4">8</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/schedule-complaints.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Complaints schedule</div>
              <div className="text-primary cta-4">1</div>
            </Card.Body>
          </Card>
        </Col>
        <Col xs="6" md="4" lg="2">
          <Card className="h-100 hover-scale-up cursor-pointer">
            <Card.Body className="d-flex flex-column align-items-center">
              <div className="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                {/* <CsLineIcons icon="message" className="text-primary" /> */}
              <img src='/img/svg/complaints-confirmed.svg' alt='pic' className='text-primary'/>
              </div>
              <div className="mb-1 d-flex align-items-center text-alternate w-full  text-md lh-1-25">Complaints confirmed</div>
              <div className="text-primary cta-4">15</div>
            </Card.Body>
          </Card>
        </Col>
      </Row>
                ...
                <Card.Body className="scroll-out">
                  <OverlayScrollbarsComponent options={{ scrollbars: { autoHide: 'leave' }, overflowBehavior: { x: 'hidden', y: 'scroll' } }} className="h-100">
                    <Row className="g-0 sh-10 mb-3">
                      <Col className="col-auto">
                        <NavLink to="/products/detail">
                          <img src="/img/product/small/product-1.png" className="card-img rounded-md h-100 sw-8" alt="thumb" />
                        </NavLink>
                      </Col>
                      <Col>
                    ...
                    <Row className="g-0 sh-10 mb-3">
                      <Col className="col-auto">
                        <NavLink to="/products/detail">
                          <img src="/img/product/small/product-2.png" className="card-img rounded-md h-100 sw-8" alt="thumb" />
                        </NavLink>
                      </Col>
                      <Col>
                        <div className="d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
                    ...
                    <Row className="g-0 sh-10 mb-3">
                      <Col className="col-auto">
                        <NavLink to="/products/detail">
                          <img src="/img/product/small/product-3.png" className="card-img rounded-md h-100 sw-8" alt="thumb" />
                        </NavLink>
                      </Col>
                      <Col>
                        <div className="d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
                    ...
                    <Row className="g-0 sh-10 mb-3">
                      <Col className="col-auto">
                        <NavLink to="/products/detail">
                          <img src="/img/product/small/product-4.png" className="card-img rounded-md h-100 sw-8" alt="thumb" />
                        </NavLink>
                      </Col>
                      <Col>
                        <div className="d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
          ...
          <div className="mb-n2">
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col className="col-auto">
                  <NavLink to="/products/detail">
                    <img src="/img/product/small/product-1.png" alt="alternate text" className="card-img card-img-horizontal sw-11" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col className="col-auto">
                  <NavLink to="/products/detail">
                    <img src="/img/product/small/product-2.png" alt="alternate text" className="card-img card-img-horizontal sw-11" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col className="col-auto">
                  <NavLink to="/products/detail">
                    <img src="/img/product/small/product-3.png" alt="alternate text" className="card-img card-img-horizontal sw-11" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col className="col-auto">
                  <NavLink to="/products/detail">
                    <img src="/img/product/small/product-4.png" alt="alternate text" className="card-img card-img-horizontal sw-11" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
