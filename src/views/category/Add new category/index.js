...
import DetailAttributeItem from 'views/products/detail/components/DetailAttributeItem';
  ...
  return (
    <>
        ...
        <Row className="g-0">
          ...
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/products">
              ...
              <span className="align-middle text-small ms-1">Categories list</span>
            </NavLink>
      ...
      <Row>
        <Col xl="8">
          {/* Category Info Start */}
          <h2 className="small-title">Category Information</h2>
            ...
            <Card.Body>
              <Form>
                ...
                <div className="mb-3">
                  ...
                  <Form.Control type="text"  placeholder="subCategory" />
                </div>
        ...
        <Col xl="4">
          ...
          {/* Image Start */}
          <h2 className="small-title">Image (drop single image)</h2>
          <Card className="mb-5">
            <Card.Body>
              <DetailImage 
              maxFiles={1}/>
