...
const AddBanner = () => {
  const title = 'Add new Banner';
  const description = 'Add new Banner Page';
  ...
  return (
    <>
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/banner/banner">
              <CsLineIcons icon="chevron-left" size="13" />
              <span className="align-middle text-small ms-1">Banners</span>
            </NavLink>
      ...
      <Row>
        <Col xl="8">
          {/* offer Info Start */}
          <h2 className="small-title">Offer Information</h2>
          <Card className="mb-5">
            <Card.Body>
              <Form>
                <div className="mb-3">
                  <Form.Label>Offer Title</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Offer Title" />
                </div>
                <div className="mb-3">
                  <Form.Label>Offer subitle</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Offer subitle" />
                </div>
                <div className="mb-3">
                  <Form.Label>Offer Details</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Offer Details" />
                </div>
                <div className="mb-3">
                  <Form.Label>Offer Description</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Offer Description" />
                </div>
            ...
            <Card.Body>
              <Form>
                <div className="mb-3">
                  ...
                  <Form.Control type="text" defaultValue=" " placeholder="Original Price" />
                </div>
                <div className="mb-3">
                  <Form.Label>Offer Price</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Offer Price" />
                </div>
        ...
        <Col xl="4">
          ...
          {/* Gallery Start */}
          <h2 className="small-title mb-2">Product Image (maximum 2 images can be drop)</h2>
          <Card className="mb-5">
            <Card.Body>
              <DetailGallery
              maxFiles={2} />
