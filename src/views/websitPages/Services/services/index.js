  ...
  const ProductData = [
    {
      ...
      Title: 'water Tanker',
      shortDescription: 'our Domestic water filters ensure clean and safe water for your weekly needs',
      option: true,
    },
  ];
  const title = 'Service Details List';
  const description = 'Service List Page';
  const allItems = [1];
        ...
        <Row className="g-0">
          ...
          <Col xs="12" sm="auto" className="d-flex align-items-end justify-content-end mb-2 mb-sm-0 order-sm-3">
            <Button variant="outline-primary" className="btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto">
              <NavLink to="/services/addService">
                <CsLineIcons icon="plus" /> <span>Add Service</span>
              </NavLink>
            </Button>
        ...
        <Col>
          <Row className="g-0 align-items-center text-start">
            <Col xs={3} className="pe-2">
              <div className="text-muted text-small">Service Image</div>
            </Col>
            <Col xs={2} className="pe-2">
              <div className="text-muted text-small">Service Title</div>
            </Col>
            <Col xs={4} className="pe-2">
              <div className="text-muted text-small">Service Short Description</div>
            </Col>
            <Col xs={2} className="pe-2">
            ...
            <Col xs={1}>
              <div className="text-muted text-small" style={{ marginLeft: '40px' }}>
                Select
              </div>
            </Col>
          </Row>
        ...
        <Row key={item.id} className="g-0 mb-2 align-items-center border-bottom pb-2">
          ...
          <Col>
            <Row className="g-0 align-items-center text-start">
              ...
              <Col xs={4} className="pe-2">
                <div className="lh-1 text-alternate">{item.shortDescription}</div>
              </Col>
              <Col xs={2} className="pe-2">
                <Button
