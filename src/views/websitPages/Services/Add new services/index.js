...
const AddService = () => {
  ...
  const description = 'Add new service Page';
  ...
  return (
    <>
        ...
        <Row className="g-0">
          ...
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/products">
              ...
              <span className="align-middle text-small ms-1">Services</span>
            </NavLink>
      ...
      <Row>
        <Col xl="8">
          {/* Service Info Start */}
          <h2 className="small-title">Service Information</h2>
          <Card className="mb-5">
            <Card.Body>
              <Form>
                <div className="mb-3">
                  <Form.Label>Service Title</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Service Title" />
                </div>
                <div>
          ...
          {/* Service Info Start */}
          <h2 className="small-title">Service Detail Information</h2>
          <Card className="mb-5">
            <Card.Body>
              <Form>
                <div className="mb-3">
                  <Form.Label>Service Heading</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Service Heading" />
                </div>
                <div className="mb-3">
                  <Form.Label>Service 
                    Subheading</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Service subheading" />
                </div>
                <div>
                <Form.Label>Service Long Description</Form.Label>
                  <Form.Control as="textarea" rows={4} defaultValue="" />
                </div>
              </Form>
            </Card.Body>
          ...
          {/* Service Info Start */}
          <h2 className="small-title">Why Choose Information</h2>
          <Card className="mb-5">
            <Card.Body>
              <Form>
                <div className="mb-3">
                  <Form.Label>Section Title</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Section Title" />
                </div>
          ...
          <h2 className="small-title">Features Information</h2>
          <Card className="mb-5">
            <Card.Body>
              <Form>
                <div className="mb-3">
                <h2 className="small-title">Feature 1</h2>
                  <Form.Label>Feature 1 Title</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Feature 1 Title" />
                </div>
                
                <div>
                <Form.Label>Feature 1 Description</Form.Label>
                  <Form.Control as="textarea" rows={4} defaultValue="" />
                </div>
                <h2 className="small-title mt-3">Feature 2</h2>
                <div className="mb-3">
                  <Form.Label>Feature 2 Title</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Feature 2 Title" />
                </div>
                <div>
                <Form.Label>Feature 2 Description</Form.Label>
                  <Form.Control as="textarea" rows={4} defaultValue="" />
                </div>
                <h2 className="small-title mt-3">Feature 3</h2>

                <div className="mb-3">
                  <Form.Label>Feature 3 Title</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Feature 3 Title" />
                </div>
                <div>
                <Form.Label>Feature 3 Description</Form.Label>
                  <Form.Control as="textarea" rows={4} defaultValue="" />
                </div>
                <h2 className="small-title mt-3">Feature 4</h2>

                <div className="mb-3">
                  <Form.Label>Feature 4 Title</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Feature 4 Title" />
                </div>
                <div>
                <Form.Label>Feature 4 Description</Form.Label>
                  <Form.Control as="textarea" rows={4} defaultValue="" />
                </div>
                <h2 className="small-title mt-3">Feature 5</h2>

                <div className="mb-3">
                  <Form.Label>Feature 5 Title</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Feature 5 Title" />
                </div>
                <div>
                <Form.Label>Feature 5 Description</Form.Label>
                  <Form.Control as="textarea" rows={4} defaultValue="" />
                </div>
                <h2 className="small-title mt-3">Feature 6</h2>

                <div className="mb-3">
                  <Form.Label>Feature 6 Title</Form.Label>
                  <Form.Control type="text" defaultValue=" " placeholder="Feature 6 Title" />
                </div>
                <div>
                <Form.Label>Feature 6 Description</Form.Label>
                  <Form.Control as="textarea" rows={4} defaultValue="" />
                </div>
        ...
        <Col xl="4">
          {/* Image Start */}
          <h2 className="small-title">Service Image (drop single image)</h2>
          <Card className="mb-5">
            <Card.Body>
              <DetailImage
              maxFiles={1} />
          ...
          {/* Gallery Start */}
          <h2 className="small-title">Images (maximum 3 images can be drop)</h2>
          <Card className="mb-5">
            <Card.Body>
              <DetailGallery
              maxFiles={3} />
