...
const Rental = () => {
  ...
  const title = 'Rental Details List';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <Col xs="12" sm="auto" className="d-flex align-items-end justify-content-end mb-2 mb-sm-0 order-sm-3">
            ...
            <NavLink to='/rentalDetails/AddRental' >
              <CsLineIcons icon="plus" /> <span>Add Rental</span>
              </NavLink>
            </Button>
      ...
      <Row className="g-0 mb-2 d-none d-lg-flex">
        ...
        <Col>
          <Row className="g-0 align-items-center text-start">
            <Col xs={3} className="pe-2"><div className="text-muted text-small">Rental Image</div></Col>
            <Col xs={3} className="pe-2"><div className="text-muted text-small">Title</div></Col>
            <Col xs={3} className="pe-2"><div className="text-muted text-small">Subtitle</div></Col>
