...
const AddRental = () => {
  const title = 'Add new Rental';
  const description = 'Add new Rental Page';
  ...
  return (
    <>
        ...
        <Row className="g-0">
          ...
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/products">
              ...
              <span className="align-middle text-small ms-1">Rent Details</span>
            </NavLink>
          ...
          <Col xs="12" sm="auto" className="d-flex align-items-end justify-content-end mb-2 mb-sm-0 order-sm-3">
            ...
            <div className="btn-group ms-1 w-100 w-sm-auto">
              <Button variant="outline-primary" className="btn-icon btn-icon-start w-100 w-sm-auto">
                <CsLineIcons icon="send" /> <span>save</span>
              </Button>
              {/* <Dropdown>
      ...
      <Row>
        <Col xl="8">
          {/* Rental Info Start */}
          <h2 className="small-title">Rental Information</h2>
          <Card className="mb-5">
            <Card.Body>
              <Form>
                <div className="mb-3">
        ...
        <Col xl="4">
          {/* Image Start */}
          <h2 className="small-title">Image (drop only 3 images)</h2>
          <Card className="mb-5">
            <Card.Body>
              <DetailImage
              maxFiles={3} />
