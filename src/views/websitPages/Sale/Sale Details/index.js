...
const Sales = () => {
  ...
  const title = 'Sale Details List';
  const description = 'Sales List Page';
  const allItems = [1];
        ...
        <Row className="g-0">
          ...
          <Col xs="12" sm="auto" className="d-flex align-items-end justify-content-end mb-2 mb-sm-0 order-sm-3">
            ...
            <NavLink to='/sale/detail'>
              <CsLineIcons icon="plus" /> <span>Add Sale</span>
              </NavLink>
            </Button>
      ...
      <Row className="g-0 mb-2 d-none d-lg-flex">
        ...
        <Col>
          <Row className="g-0 align-items-center text-start">
            <Col xs={3} className="pe-2"><div className="text-muted text-small">Sales Image</div></Col>
