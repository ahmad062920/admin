  ...
  return (
    <>
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/brands">
              <CsLineIcons icon="chevron-left" size="13" />
              <span className="align-middle text-small ms-1">Brand</span>
            </NavLink>
      ...
      <Row>
        <Col xl="8">
          {/* Category Info Start */}
          <h2 className="small-title">Brand Information</h2>
