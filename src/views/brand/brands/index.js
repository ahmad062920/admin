        ...
        <Row className="g-0">
          ...
          <Col xs="12" sm="auto" className="d-flex align-items-end justify-content-end mb-2 mb-sm-0 order-sm-3">
            <Button variant="outline-primary" className="btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto">
              <NavLink to='/brands/detail'>
              <CsLineIcons icon="plus" /> <span>Add New Brand</span>
              </NavLink>
            </Button>
...
<Row className="g-0 mb-2 d-none d-lg-flex">
  ...
  <Col>
    <Row className="g-0 align-items-center text-start">
      <Col xs={3}><div className="text-muted text-small">Product Image</div></Col>
      <Col xs={3}><div className="text-muted text-small">Brand Name</div></Col>
      <Col xs={3}><div className="text-muted text-small">Edit</div></Col>
      <Col xs={3}><div className="text-muted text-small">Select</div></Col>
    </Row>
  </Col>
</Row>
  ...
  <Row key={item.id} className="g-0 mb-2 align-items-center border-bottom pb-2">
    ...
    <Col>
      <Row className="g-0 align-items-center text-start">
        ...
        <Col xs={3}>
          <div className="lh-1 text-alternate">{item.BrandName}</div>
        </Col>
        <Col xs={3}>
          <Button
            variant="outline-primary"
            className="btn-icon btn-icon-only"
            style={{ height: 25, width: 25, padding: 2 }}
          >
            <NavLink to="/brands/detail">
