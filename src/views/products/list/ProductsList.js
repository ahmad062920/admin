  ...
  const ProductData = [
    {
      ...
      Quantity: '100',
      RegularRentPrice: 'AED 70.00',
      RegularBuyPrice: 'AED 990.00',
      option: true,
    },
    {
      id: 2,
      ...
      <Row className="g-0 mb-2 d-none d-lg-flex">
        ...
        <Col>
          <Row className="g-0 align-items-center text-center">
            <Col className="pe-2">
              <div className="text-muted text-small">Product Image</div>
            </Col>
            <Col className="pe-2">
              <div className="text-muted text-small">SKU</div>
            </Col>
            <Col className="pe-2">
              <div className="text-muted text-small">Product Name</div>
            </Col>
            <Col className="pe-2">
              <div className="text-muted text-small">Main Category</div>
            </Col>
            <Col className="pe-2">
              <div className="text-muted text-small">Quantity</div>
            </Col>
            <Col className="pe-2">
              <div className="text-muted text-small">Regular Rent Price</div>
            </Col>
            <Col className="pe-2">
              <div className="text-muted text-small">Regular Buy Price</div>
            </Col>
            <Col className="pe-2">
              <div className="text-muted text-small">Edit</div>
            </Col>
            <Col>
              <div className="text-muted text-small">Select</div>
            </Col>
          </Row>
        </Col>
      </Row>
        ...
        <Row key={item.id} className="g-0 mb-2 align-items-center border-bottom pb-2">
          ...
          <Col>
            <Row className="g-0 align-items-center text-center">
              ...
              <Col className="pe-2">
                <Badge bg="outline-primary">{item.RegularRentPrice}</Badge>
              </Col>
              <Col className="pe-2">
                <Badge bg="outline-primary">{item.RegularBuyPrice}</Badge>
              </Col>
              <Col>
                <Button
